...
CREATE TABLE `event_attendance` (
  ...
  CONSTRAINT `event_sid` FOREIGN KEY (`student_id`) REFERENCES `student_demographic` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `faculty_loading` (
  ...
  CONSTRAINT `sub_id` FOREIGN KEY (`subid`) REFERENCES `subjects` (`idsubjects`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student_enrollment` (
  ...
  CONSTRAINT `student_id` FOREIGN KEY (`student_id`) REFERENCES `student_demographic` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student_enrollment` VALUES (222011,'Abala, Alessandra Sevilla','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-08'),(2400167,'Alcarde, Mark Joseph Mirador','Male','4th','BS in Psy','Old','Irregular','ENROLLED','2025-01-13'),(222009,'Alfaro, Ashley Mhae Caspar','Female','3rd','BS in FS','Old','Regular','ENROLLED','2025-01-09'),(222025,'Alfuente, Kurt Alexandre Estanislao','Male','3rd','BS in Psy','New/Transferee','Irregular','ENROLLED','2025-01-13'),(222023,'Alonte, Denize Anne Balingit','Female','3rd','BS in TM','Old','Regular','ENROLLED','2025-01-09'),(222024,'Alonte, Razel Anne Balingit','Female','3rd','BS in FS','Old','Regular','ENROLLED','2025-01-10'),(223010,'Ampil, Daniel Francis Victoria','Male','2nd','BS in BA','Old','Regular','ENROLLED','2025-01-09'),(2013433,'Andres, Paul Jordan Canigan','Male','1st','BS in CS','New/Freshmen','Regular','ENROLLED','2025-01-08'),(224014,'Aquino, Raphael James Miguel','Male','1st','BS in CS','New/Freshmen','Regular','ENROLLED','2025-01-09'),(224001,'Argame, Kevin Quill R.','Male','1st','BS in m','New/Freshmen','Regular','ENROLLED','2025-01-08'),(222007,'Avelino, Jan Gabrielle','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-13'),(224003,'Bagason, Patrick Elizalde M.','Male','1st','BS in m','New/Freshmen','Regular','ENROLLED','2025-01-09'),(222005,'Bagayas, Clemrose Faith Manrique','Female','3rd','BS in HM','Old','Regular','ENROLLED','2025-01-13'),(221004,'Bagayas, Many Nathalie Manrique','Female','4th','BS in Psy','Old','Regular','ENROLLED','2025-01-09'),(223022,'Bancosta, Cathleen Ann Rodolfo','Female','2nd','BS in Psy','Old','Regular','ENROLLED','2025-01-09'),(222022,'Blanco, Norwen Boy','Male','3rd','BS in IT','Old','Regular','ENROLLED','2025-01-13'),(224007,'Bravo, Maria Isabella Buenaflor','Female','1st','BS in Psy','New/Freshmen','Regular','ENROLLED','2025-01-09'),(224011,'Cabalsa, Joejuana Bunacod','Female','1st','BS in IT','New/Freshmen','Regular','ENROLLED','2025-01-08'),(222032,'Cabrales, Aedin Jerome Reyes','Male','3rd','BS in CS','Old','Regular','ENROLLED','2025-01-14'),(2015236,'Calibo, Celeste Jellena Petil','Female','4th','BS tn Psy','Old','Irregular','ENROLLED','2025-01-09'),(222016,'Carencia, Crizelle Ann Cruz','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-09'),(223026,'Clemente, Nash Jermaine Mercado','Female','2nd','BS in CS','Old','Regular','ENROLLED','2025-01-14'),(2011443,'De Leon , Roy Mj Baquir','Male','1st','BS in HM','New/Transferee','Irregular','ENROLLED','2025-01-09'),(222018,'Del Rosario, Bea Jade','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-09'),(222014,'Dela Vega, Alyanna Nicole Calman','Female','3rd','BS in CS','Old','Regular','ENROLLED','2025-01-08'),(223007,'Desa, Anne Gabrielle','Female','2nd','BS in HM','Old','Regular','ENROLLED','2025-01-09'),(223017,'Dichoso, Gwyneth Shane Tangco','Female','2nd','BS in Psy','Old','Regular','ENROLLED','2025-01-13'),(2800148,'Dijamco, Ellyn Jewel Anne Isidro','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-08'),(2011440,'Dimaano, Elric Lewis Serviento','Male','4th','BS in CS','Old','Irregular','ENROLLED','2025-01-10'),(2800332,'Dinglasan, Angelo Agaran','Male','3rd','BS in IT','Old','Regular','ENROLLED','2025-01-08'),(221003,'Diho, Andrea Joyce Macabare','Female','4th','BS in Psy','Old','Regular','ENROLLED','2025-01-13'),(224023,'Dino, Jamilla Mae Estorpe','Female','1st','BA in Comm','New/Freshmen','Regular','ENROLLED','2025-01-10'),(223019,'Dizon, Carl Joshua Aguila','Male','4th','BS in Psy','Old','Irregular','ENROLLED','2025-01-13'),(221011,'Dojeta, Neil Andrews Isabelo','Male','4th','BS in CS','Old','Regular','ENROLLED','2025-01-09'),(223009,'Endrada, Alliyah Lorraine Dela Rosa','Female','2nd','BS in BA','Old','Regular','ENROLLED','2025-01-08'),(224022,'Espeleta, Judy Ann Maligo','Female','2nd','BS in TM','Newmransferee','Irregular','ENROLLED','2025-01-10'),(224015,'Espina, Diana Grace Blarito','Female','1st','BS in CS','New/Freshmen','Regular','ENROLLED','2025-01-09'),(2700325,'Fanio, Lance Andrei Baylon','Male','1st','BS in FS','New/Freshmen','Regular','ENROLLED','2025-01-13'),(222008,'Faraon, Rizelle Mari Manalo','Female','3rd','BS in FS','Old','Regular','ENROLLED','2025-01-10'),(224018,'Garcia, Alena Beatriz Manaoat','Female','1st','BS in FS','New/Freshmen','Regular','ENROLLED','2025-01-14'),(222017,'Getalado, Sara Abygail Calve','Female','3rd','BS in IT','Old','Regular','ENROLLED','2025-01-10'),(221005,'Gonzalo, Tirshatha Shobek Dacasin','Female','4th','BS in Psy','Old','Regular','ENROLLED','2025-01-10'),(223008,'Gudani, Edeah Thane Palaruan','Female','2nd','BA in Comm','Old','Regular','ENROLLED','2025-01-08'),(222010,'Guerra, John Hendrick Hebreo','Male','4th','BS in Psy','Old','Irregular','ENROLLED','2025-01-14'),(221006,'Guico, Jem Mariel Santos','Female','4th','BS in Psy','Old','Regular','ENROLLED','2025-01-08'),(223018,'llar, Cassandra Gelaine Perez','Female','2nd','BS in BA','Old','Regular','ENROLLED','2025-01-15'),(223016,'Ilisan, Jasper Sion','Male','2nd','BS in IT','Old','Regular','ENROLLED','2025-01-10'),(224009,'Jenon, Maria Annetonette Barabicho','Female','1st','BS in HM','New/Freshmen','Regular','ENROLLED','2025-01-10'),(224012,'Laurenciano, Kate Christine Tica','Female','1st','BS in FS','New/Freshmen','Regular','ENROLLED','2025-01-15'),(223002,'Lobaton, Christopher Jr. David','Male','3rd','BS in HM','Old','Irregular','ENROLLED','2025-01-08'),(224004,'Luna, Erika Ann Tagle','Female','1st','BA in Comm','New/Freshmen','Regular','ENROLLED','2025-01-10'),(222012,'Malabo, Joshua Lerpido','Male','3rd','BS in IT','Old','Regular','ENROLLED','2025-01-10'),(224020,'Manahan, John Benedict Gomez','Male','1st','BS in Psy','New/Freshmen','Regular','ENROLLED','2025-01-15'),(222004,'Matas, Al Christian Dela Rosa','Male','3rd','BS in Psy','Returnee','Irregular','ENROLLED','2025-01-15'),(224008,'Pabalan, Shania Dela Cruz','Female','1st','BS in IT','New/Freshmen','Regular','ENROLLED','2026-01-15'),(222033,'Pacoma, Tristan Domondon','Male','3rd','BS in BA','Old','Regular','ENROLLED','2025-01-09'),(221009,'Par, Sarah Joy Tidula','Female','4th','BS in Psy','Old','Irregular','ENROLLED','2025-01-16'),(222021,'Polmo Jr., Albert Orbidalla','Male','3rd','BS in HM','Old','Irregular','ENROLLED','2025-01-10'),(222015,'Ranas, Crizzia Faith Canobida','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-08'),(224002,'Recacho, Karla Benice Miranda','Female','1st','BS in Psy','New/Freshmen','Regular','ENROLLED','2025-01-08'),(224013,'Regencia, Ashley Amante','Female','1st','BS in IT','New/Freshmen','Regular','ENROLLED','2025-01-08'),(222013,'Reopirio, Tricia Mae Labaco','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-14'),(2022455,'Rodriguez, Maynard Matiey Unsay','Male','3rd','BS in CS','Old','Regular','ENROLLED','2025-01-09'),(222028,'Rondilla, Aaron Christian Alante','Male','3rd','BS in TM','Old','Regular','ENROLLED','2025-01-09'),(222026,'Rosales, Justine Christian','Male','3rd','BS in IT','Old','Irregular','ENROLLED','2025-01-14'),(224021,'Salazar, Hanna Isabelle Dandan','Female','2nd','BS in Psy','New/Transferee','Irregular','ENROLLED','2025-01-14'),(224017,'Salinas, James Rafael Rioflorido','Male','1st','BS in HM','New/Freshmen','Regular','ENROLLED','2025-01-22'),(223028,'Salonga, Sherr Andrei Pastoral','Male','2nd','BS in BA','Old','Regular','ENROLLED','2025-01-15'),(2021249,'Salvador, Edcel Lorente','Male','1st','BS in Psy','New/Freshmen','Regular','ENROLLED','2025-01-22'),(224006,'Santos, Ralph Franco','Male','1st','BS in TM','New/Freshmen','Regular','ENROLLED','2025-01-08'),(223023,'Sia, Jordan Alcade Bandian','Male','2nd','BS in CS','Old','Regular','ENROLLED','2025-01-09'),(224019,'Solis, Bianca Chanelle Calderon','Female','1st','BS in Psy','New/Freshmen','Regular','ENROLLED','2025-01-15'),(223012,'Solis, Nhia Leecole Calderon','Female','2nd','BS in CS','Old','Regular','ENROLLED','2025-01-08'),(223015,'Sumalinab, Michaela Mist Pagsac','Female','2nd','BS in FS','Old','Regular','ENROLLED','2025-01-14'),(223030,'Supremo, Dean Aries Rafael Arenas','Male','2nd','BA in Comm','Old','Irregular','ENROLLED','2025-01-13'),(224005,'Tanjusay, Lissa Mariz Garcia','Female','1st','BS n HM','New/Freshmen','Regular','ENROLLED','2025-01-10'),(2018716,'Venturanza, Gurshwyn Krey Lucero','Male','1st','BS in BA','New/Freshmen','Regular','ENROLLED','2025-01-08'),(224016,'Villena, Francis Lacsinto','Male','1st','BS in FS','New/Freshmen','Regular','ENROLLED','2025-01-09'),(224010,'Yabut, Beatrice Ange','Female','2nd','BS in BA','Newmransferee','Irregular','ENROLLED','2025-01-08'),(222031,'Zapata, Paulla Shane Layoso','Female','3rd','BS in Psy','Old','Regular','ENROLLED','2025-01-14');
...
-- Dump completed on 2025-03-26 15:49:32
